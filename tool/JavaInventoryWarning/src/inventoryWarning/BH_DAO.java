	...
	public boolean equals(Object obj){
		if(obj != null){
			...
			if(obj instanceof BH_DAO){
				...
				if( this.getExtSkuId().equals(bhDao.getExtSkuId()) && this.getSkuId().equals(bhDao.getSkuId())
						&& this.getHardwareId().equals(bhDao.getHardwareId()) && this.getBinId().equals(bhDao.getBinId()) ){
					return true;
				}
			}
		}
