...
class com.yahoo.decorator.Observer
{
	...
	static function makeObservable(obj:Object):Void
	{
		...
		if(obj instanceof com.yahoo.event.Observable)
		{
			return;
		}
	...
	private function addEventObserver():Void
	{
		...
		while(count<len){
			...
			if(!hasObserver(yahoo_Observer_listeners[eID], lObj)){
				yahoo_Observer_listeners[eID].push(new com.yahoo.event.EventObserver(lObj, eID));
			}
			count++;
		}
	...
	private function dispatchEvent(e:com.yahoo.event.Event)
	{
