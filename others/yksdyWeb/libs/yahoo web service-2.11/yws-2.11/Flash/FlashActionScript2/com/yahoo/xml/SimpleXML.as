 ...
 * @see     XML	
 */
class com.yahoo.xml.SimpleXML extends XML implements Observable
{
	...
	public function SimpleXML()
	{
		...
		this.$timeLimit = 1000;
		this.$retries = 2;
		this.setClassDescription('com.yahoo.xml.SimpleXML');
		this.$eventDispatcher = new EventDispatcher();
	}

	/**
	 * 
	 * @param   str (String) String to print on the output window and debug stack
	 */
	public function trace(str):Void
	{
		str = '['+this.$instanceDescription+'] ' + str;
	}

	private function setClassDescription(d:String):Void
	{
		if(com.yahoo.util.ObjectUtil.isExplicitInstanceOf(this, eval(d)) == false)
		{
			d = 'subclass of ' + d;
		}
